  ...
  return (
    <div className="voguepay">
      <header className="App-header">
        ...
        >
          ...
          <input
            type="hidden"
            name="memo"
            value='Purchase MacBook Pro 16" Touchbar'
          />

          <input
            type="hidden"
            name="notify_url"
            value="//www.mydomain.com/notification.php"
          />
          <input
            type="hidden"
            name="success_url"
            value="//www.mydomain.com/thank_you.html"
          />
          <input
            type="hidden"
            name="fail_url"
            value="//www.mydomain.com/failed.html"
          />
          ...
          <input
            type="hidden"
            name="address"
            value="John Doe Avenue, Lagos, Nigeria."
          />
      ...
      <div className="secure">
        <img className="secure" src={secure} alt="secured-with-voguepay" />
      </div>
    </div>
  )
}
